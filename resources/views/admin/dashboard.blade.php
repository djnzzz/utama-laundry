...
<head>
    ...
    <title>Admin Dashboard - Utama Laundry</title>
...
<div class="admin-wrapper">
    ...
    <main class="main-content">
        <div class="content-header">
            ...
            <p class="subtitle">Selamat datang di panel admin Utama Laundry</p>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value">{{ number_format($stats['total_orders']) }}</h2>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value">{{ number_format($stats['pending_orders']) }}</h2>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value">Rp {{ number_format($stats['total_revenue'], 0, ',', '.') }}</h2>
                </div>
            </div>
        ...
        <div class="quick-actions">
            ...
            <div class="action-grid">
                <a href="{{ route('admin.price.management') }}" class="action-card">
